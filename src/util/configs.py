...
# Database paths
DATABASE_ORIGINAL_DIR = 'data/database/original'
DATABASE_REFINED_DIR = 'data/database/refined'
...
DATABASE_NORMALIZED_DESCRIPTORS_FILENAME = 'normalized_descriptors.csv'
